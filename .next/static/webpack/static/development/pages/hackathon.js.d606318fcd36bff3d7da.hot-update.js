...
var site = {
  ...
  hackathon: {
    ...
    details: [{
      ...
      topics: ['Monte sua Equipe, ela deve ser composta por  no mínimo 5 e no máximo 7 participantes. Lembrando que você precisa escolher para sua equipe, colegas das outras unidades da Conductor (ao menos 1 de cada unidade) e de Squads diferentes.', 'Inscreva-se no evento! Se for em uma equipe, cada um deve realizar sua inscrição.']
    }, {
      title: 'Eita! E como será o Hackathon?',
      description: 'Ocorrerá no dia 22 a 28 de abril de 2019!',
      topics: ['Um tema será lançado e as equipes inscritas deverão formular uma ideia e, literalmente, desenvolvê-la.', 'A tecnologia utilizada? Vocês escolhem!', 'Vocês poderão desenvolver um produto desktop, mobile ou web... vocês escolhem!', 'Ao final do evento, a equipe deverá apresentar o projeto para os jurados. Vocês terão 5 minutos para apresentar o projeto e os jurados terão 5 minutos para questionamentos.', 'Caprichem no produto! Cresçam na apresentação! Conquistem os jurados!']
    }],
    awards: [{
      title: '3º Lugar',
      award: '2 mil reais'
...
//# sourceMappingURL=hackathon.js.d606318fcd36bff3d7da.hot-update.js.map